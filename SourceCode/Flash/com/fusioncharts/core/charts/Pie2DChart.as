...
class com.fusioncharts.core.charts.Pie2DChart extends Chart {
				...
				for (var j = 0; j<arrLevel1Nodes.length; j++) {
					...
					if (arrLevel1Nodes[j].nodeName.toUpperCase() == "SET") {
						...
						if ((setValue != 0 || this.params.showZeroPies) && !isNaN(setValue) && setFillAlpha != 0) {
							...
							this.data[this.num-1] = this.returnDataAsObject(setLabel, setShowLabel, setValue, setColor, color, setExDispVal, setBorderColor, setFillAlpha, setBorderAlpha, setToolText, setLink, setIsSliced, setIsDashed);
						}
	...
	*/
	 ...
	 */
	private function returnDataAsObject(dataLabel:String, showLabel:Boolean, dataValue:Number, color:Number, hexColor:String, displayValue:String, bordercolor:Number, fillAlpha:Number, borderAlpha:Number, toolText:String, link:String, isSliced:Boolean, isDashed:Boolean):Object {
		//Create a container

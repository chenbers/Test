...
class com.fusioncharts.core.charts.Doughnut3DChart extends Chart {
				...
				for (var j = 0; j<arrLevel1Nodes.length; j++) {
					...
					if (arrLevel1Nodes[j].nodeName.toUpperCase() == "SET") {
						...
						if ((setValue != 0 || this.params.showZeroPies) && !isNaN(setValue)) {
							...
							this.data[this.num-1] = this.returnDataAsObject(setLabel, setShowLabel, setValue, setColor, color, setExDispVal,  setBorderColor, setToolText, setLink, setIsSliced);
						}
	...
	*/
	 ...
	 */
	private function returnDataAsObject(dataLabel:String, showLabel:Boolean, dataValue:Number, color:Number, hexColor:String, displayValue:String, bordercolor:Number, toolText:String, link:String, isSliced:Boolean):Object {
		//Create a container

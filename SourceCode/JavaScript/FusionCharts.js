...
(function () {
    ...
    // the page has loaded.
    if (!(/loaded|complete/.test(document.readyState) || document.loaded)) {
        (function () {
            ...
            if (/msie/i.test(navigator.userAgent) && !window.opera) {
              try {
                  if (location.protocol === 'https:') {
                      document.write('<script id="__ie_onload_fusioncharts" defer="defer" src="//:"><\/script>');
                  }
                  else {
                      document.write('<script id="__ie_onload_fusioncharts" defer="defer" src="javascript:void(0)"><\/script>');
                  }
                  var script = document.getElementById("__ie_onload_fusioncharts");

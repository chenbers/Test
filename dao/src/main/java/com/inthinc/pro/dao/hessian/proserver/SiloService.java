...
//--------------------------------------------------------------------------------------------------------
    ...
    Map<String, Object> getVehicleByName(String name) throws ProDAOException;

    Map<String, Object> getTestText() throws ProDAOException;
    ...
    List<Map<String, Object>> getVehicleNamesByGroupIDDeep(Integer groupID) throws ProDAOException;
 ...
 // ?? TODO: should backend support this one    
    ...
    List<Map<String, Object>> getPersonsByAcctID(Integer acctID) throws ProDAOException;
    ...
    Map<String, Object> getPersonByEmpid( Integer acctID, String empID) throws ProDAOException;

...
public enum ScoreType implements BaseEnum
{
    ...
    SCORE_DRIVING_STYLE_HARD_BRAKE(15, "SCORE_DRIVING_STYLE_HARD_BRAKE", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_BRAKE),
    SCORE_DRIVING_STYLE_HARD_ACCEL(16, "SCORE_DRIVING_STYLE_HARD_ACCEL", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_ACCEL),
    SCORE_DRIVING_STYLE_HARD_TURN(17, "SCORE_DRIVING_STYLE_HARD_TURN", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_TURN),
    SCORE_DRIVING_STYLE_HARD_LTURN(18, "SCORE_DRIVING_STYLE_HARD_LTURN", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_LEFT),
    SCORE_DRIVING_STYLE_HARD_RTURN(19, "SCORE_DRIVING_STYLE_HARD_RTURN", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_RIGHT),
    SCORE_DRIVING_STYLE_HARD_BUMP(20, "SCORE_DRIVING_STYLE_HARD_BUMP", DriveQMetric.DRIVEQMETRIC_AGGRESSIVE_BUMP);

...
public enum TimeFrame {
    ...
    WEEK(AggregationDuration.SEVEN_DAY) {
        public Interval getInterval() {
            return new Interval(new DateMidnight(new DateTime().minusWeeks(1), DateTimeZone.UTC), new DateMidnight(new DateTime().plusDays(1), DateTimeZone.UTC));
        }
    },
    MONTH(AggregationDuration.ONE_MONTH) {
        public Interval getInterval() {
            return new Interval(new DateMidnight(new DateTime().minusMonths(1), DateTimeZone.UTC), new DateMidnight(new DateTime().plusDays(1), DateTimeZone.UTC));
        }
    },
    THREE_MONTHS(AggregationDuration.THREE_MONTH) {
        public Interval getInterval() {
            return new Interval(new DateMidnight(new DateTime().minusMonths(3), DateTimeZone.UTC), new DateMidnight(new DateTime().plusDays(1), DateTimeZone.UTC));
        }
    },
    SIX_MONTHS(AggregationDuration.SIX_MONTH) {
        public Interval getInterval() {
            return new Interval(new DateMidnight(new DateTime().minusMonths(6), DateTimeZone.UTC), new DateMidnight(new DateTime().plusDays(1), DateTimeZone.UTC));
        }
    },
    YEAR(AggregationDuration.TWELVE_MONTH) {
        public Interval getInterval() {
            return new Interval(new DateMidnight(new DateTime().minusYears(1), DateTimeZone.UTC), new DateMidnight(new DateTime().plusDays(1), DateTimeZone.UTC));
        }
    };

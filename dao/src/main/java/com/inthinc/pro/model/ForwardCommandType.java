...
//    SEND_TRIAX_ORIENT(2021),   ? NOT SUPPORTED?
    ...
    DMM_SET_HARD_ACCEL(2091,"Adjust Hard Acceleration Thresholds.  Parameter(String): <Peak to Peak level> <RMS level> <SensitivitySlider Position>"),
    DMM_SET_HARD_BRAKE(2092,"Adjust Hard Brake Thresholds.  Parameter(String): <Peak to Peak level> <RMS level> <SensitivitySlider Position>"),
    DMM_SET_HARD_TURN(2093,"Adjust Hard Turn Thresholds.  Parameter(String): <Peak to Peak level> <RMS level> <SensitivitySlider Position>"),
    DMM_SET_HARD_VERT(2094, "Adjust Hard Vertical Thresholds.  Parameter(String): <Peak to Peak level> <RMS level> <SensitivitySlider Position>"),

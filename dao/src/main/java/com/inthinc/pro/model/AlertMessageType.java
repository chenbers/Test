...
//    ALERT_TYPE_LOW_BATTERY_POTENTIAL_TAMPERING(22),   
    ...
    ALERT_TYPE_DVIR_PRE_TRIP_FAIL(37),
    ALERT_TYPE_DVIR_PRE_TRIP_PASS(38),
    ALERT_TYPE_DVIR_POST_TRIP_FAIL(39),
    ALERT_TYPE_DVIR_POST_TRIP_PASS(40),
    ...
    ATTR_ENGINE_HOURS(52),
    ATTR_MALFUNCTION_INDICATOR_LAMP(53),
    ATTR_CHECK_ENGINE(54),
    ATTR_MAINTENANCE_CAPABILITIES(55);

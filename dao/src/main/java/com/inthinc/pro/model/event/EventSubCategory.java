...
public enum EventSubCategory implements BaseEnum
{
    ...
    NOTIFICATION_MAINTENANCE(19,
                             ...
                             EventType.CHECK_ENGINE,EventType.MALFUNCTION_INDICATOR_LAMP,EventType.ENGINE_HOURS,
                             EventType.RED_STOP,EventType.AMBER_WARNING,EventType.PROTECT),
    EnumSet.of(AlertMessageType.ATTR_BATTERY_VOLTAGE,AlertMessageType.ATTR_ENGINE_TEMP,AlertMessageType.ATTR_TRANSMISSION_TEMP,AlertMessageType.ATTR_DPF_FLOW_RATE,
    AlertMessageType.ATTR_OIL_PRESSURE,AlertMessageType.ATTR_MALFUNCTION_INDICATOR_LAMP,AlertMessageType.ATTR_CHECK_ENGINE,
    AlertMessageType.ATTR_ENGINE_HOURS,AlertMessageType.ATTR_RED_STOP,AlertMessageType.ATTR_AMBER_WARNING,AlertMessageType.ATTR_PROTECT));

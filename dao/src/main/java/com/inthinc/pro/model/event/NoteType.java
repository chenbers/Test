...
public enum NoteType implements BaseEnum {
    ...
    WAYSMART_DOT_STOPPED(56, EventType.DOT_STOPPED), //WAYSMART
    ...
    WAYSMART_HOS_NO_HOURS(67, EventType.HOS_NO_HOURS), //WAYSMART
    WAYSMART_WAYPOINT(71), //WAYSMART
    WAYSMART_TEXT_MSG(72), //WAYSMART
    WAYSMART_FUEL_STOP(73), //WAYSMART
    
    FIRMWARE_UP_TO_DATE(74, EventType.FIRMWARE_CURRENT),
    MAPS_UP_TO_DATE(75),
    ZONES_UP_TO_DATE(76, EventType.ZONES_CURRENT),
    ...
    WAYSMART_QSI_UP_TO_DATE(122, EventType.QSI_UPDATED), //WAYSMART

    WITNESS_UP_TO_DATE(123, EventType.WITNESS_UPDATED),
    ...
    WAYSMART_PARKINGBRAKE(172, EventType.PARKING_BRAKE), //WAYSMART 

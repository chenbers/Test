...
public enum NoteType implements BaseEnum {
    ...
    WAYSMART_INVALID_DRIVER(103, InvalidDriverEvent.class), //WAYSMART
    WAYSMART_INVALID_OCCUPANT(104, InvalidOccupantEvent.class), //WAYSMART
    WAYSMART_VALID_OCCUPANT(105, ValidOccupantEvent.class), //WAYSMART
    ...
    WAYSMART_NEWDRIVER_HOSRULE(116, ValidDriverEvent.class), //WAYSMART
    ...
    WAYSMART_OFF_HOURS_DRIVING(218),

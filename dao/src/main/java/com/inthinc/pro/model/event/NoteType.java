...
public enum NoteType implements BaseEnum {
    ...
    WAYSMART_SATELLITE_SWITCH(53,EventType.RF_SWITCH), //WAYSMARTRT
    ...
    WAYSMART_TEXT_MSG(72,EventType.TEXT_MESSAGE), //WAYSMART
    ...
    WAYSMART_TEXT_MSG_CANNED(80,EventType.TEXT_MESSAGE), //WAYSMART

...
public enum NoteType implements BaseEnum {
    ...
    WAYSMART_DRIVERSTATE_CHANGE_EX(96, EventType.NEW_OCCUPANT), //WAYSMART
    WAYSMART_LIGHT_DUTY(97), //WAYSMART
    WAYSMART_HEAVY_DUTY(98), //WAYSMART
    WAYSMART_MISSING_IWI_CONF(99), //WAYSMART
    WAYSMART_INVALID_DRIVER(103, EventType.INVALID_DRIVER), //WAYSMART
    WAYSMART_INVALID_OCCUPANT(104, EventType.INVALID_OCCUPANT), //WAYSMART
    ...
    WAYSMART_NEWDRIVER_HOSRULE(116, EventType.NEW_DRIVER), //WAYSMART

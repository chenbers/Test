...
public class AccountAttributes extends BaseEntity {
    ...
    public String getTrailersEnabled() {
        return (trailersEnabled == null) ? "false" : trailersEnabled;
    }

    public void setTrailersEnabled(String trailersEnabled) {
        this.trailersEnabled = trailersEnabled;
    }



    public String getDriveTimeViolationsReportEnabled() {
        if (driveTimeViolationsReportEnabled == null)
            return "false";
        return driveTimeViolationsReportEnabled;
    }

    public void setDriveTimeViolationsReportEnabled(String driveTimeViolationsReportEnabled) {
        this.driveTimeViolationsReportEnabled = driveTimeViolationsReportEnabled;
    }
    ...
    public List<CellProviderType> getPhoneControlProviders() {
        ...
        try {
            if (phoneControlProvider1 != null)
                phoneControlProviders.add(CellProviderType.valueOf(Integer.parseInt(phoneControlProvider1)));
        } catch (NumberFormatException nfe) {}
        try {
            if (phoneControlProvider2 != null)
                phoneControlProviders.add(CellProviderType.valueOf(Integer.parseInt(phoneControlProvider2)));
        } catch (NumberFormatException nfe) {}
        try {
            if (phoneControlProvider3 != null)
                phoneControlProviders.add(CellProviderType.valueOf(Integer.parseInt(phoneControlProvider3)));
        } catch (NumberFormatException nfe) {}

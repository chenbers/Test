...
public interface ReportTestConst {
    ...
    public static final WS waySmartEventIndexes[] = {
        new WS(NOTE_EVENT_SECONDARY_IDX, NoteType.WAYSMART_NOTEEVENT_SECONDARY),
        new WS(HARD_VERT_820_IDX, NoteType.WAYSMART_VERTICALEVENT),
        new WS(HARD_VERT_820_SECONDARY_IDX, NoteType.WAYSMART_VERTICALEVENT_SECONDARY),
        new WS(SPEEDING_EXT_IDX, NoteType.WAYSMART_SPEEDING_EX4),
        new WS(NO_DRIVER_IDX, NoteType.NO_DRIVER),
        new WS(PARKING_BRAKE_IDX, NoteType.WAYSMART_PARKINGBRAKE),
        new WS(MICRO_SLEEP_IDX, NoteType.WAYSMART_DSS_MICROSLEEP),
        new WS(LOW_BATTERY_POTENTIAL_IDX, NoteType.WAYSMART_LOW_BATTERY_POTENIAL_TAMPERING),
        new WS(WIRELINE_ALARM_IDX, NoteType.WAYSMART_WIRELINE_ALARM),
        new WS(INSTALL_IDX, NoteType.WAYSMART_INSTALL),
        new WS(FIRMWARE_CURRENT_IDX, NoteType.FIRMWARE_UP_TO_DATE),
        new WS(LOCATION_DEBUG_IDX, NoteType.WAYSMART_LOCATIONDEBUG),
        new WS(QSI_UPDATED_IDX, NoteType.WAYSMART_QSI_UP_TO_DATE),
        new WS(WITNESS_UPDATED_IDX, NoteType.WITNESS_UP_TO_DATE),
        new WS(ZONES_UPDATED_IDX, NoteType.ZONES_UP_TO_DATE),
        new WS(NO_INTERNAL_THUMB_DRIVE_IDX, NoteType.WAYSMART_NO_INTERNAL_THUMB_DRIVE),
        new WS(WITNESS_HEARTBEAT_VIOLATION_IDX, NoteType.WAYSMART_WITNESS_HEARTBEAT_VIOLATION),
        new WS(ROLLOVER_IDX, NoteType.WAYSMART_ROLLOVER),
        new WS(PANIC_IDX, NoteType.WAYSMART_PANIC),
        new WS(AUTO_MAN_DOWN_IDX, NoteType.WAYSMART_AUTOMANDOWN),
        new WS(AUTO_MAN_DOWN_CANCEL_IDX, NoteType.WAYSMART_AUTO_MAN_OK),
        new WS(MAN_DOWN_IDX, NoteType.WAYSMART_MANDOWN),
        new WS(MAN_DOWN_OK_IDX, NoteType.WAYSMART_MAN_OK),
        new WS(MAN_DOWN_CANCEL_IDX, NoteType.WAYSMART_MAN_OK),
        new WS(REMOTE_AUTO_MAN_DOWN_IDX, NoteType.WAYSMART_REMOTE_AUTO_MANDOWN),
        new WS(REMOTE_MANUAL_MAN_DOWN_IDX, NoteType.WAYSMART_REMOTE_MAN_MANDOWN),
        new WS(DOT_STOPPED_IDX,NoteType.WAYSMART_DOT_STOPPED),
        new WS(HOS_NO_HOURS_REMAINING_IDX, NoteType.WAYSMART_HOS_NO_HOURS)
    };

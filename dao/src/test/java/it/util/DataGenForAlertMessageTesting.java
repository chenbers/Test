...
public class DataGenForAlertMessageTesting  extends DataGenForTesting {
	...
	protected void parseArguments(String[] args) {
		...
		String usageErrorMsg = "Usage: DataGenForAlertMessageTest <xml file path>";
    ...
    public static void main(String[] args)
    {
    	...
    	DataGenForAlertMessageTesting  testData = new DataGenForAlertMessageTesting();

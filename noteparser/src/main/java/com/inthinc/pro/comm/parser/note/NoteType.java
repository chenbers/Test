...
///////////////////////////////////////////////
	...
	HOS_CHANGE_STATE_NO_GPS_LOCK(113, new Attrib[]{Attrib.DRIVERSTATUS, Attrib.DRIVERFLAG, Attrib.DRIVERSTR, Attrib.LOCATION, Attrib.VEHICLE_KIOSK}),
...
//	WITNESSII_ARCHIVED_TRACE_UPLOADED(134, new Attrib[]{Attrib.WITNESSIIARCHIVEHEADER, Attrib.WITNESSIIARCHIVE}),
    ...
    MAINTENANCE(238, new Attrib[]{Attrib.ATTR_BATTERY_VOLTAGE, Attrib.ATTR_ENGINE_TEMP , Attrib.ATTR_TRANSMISSION_TEMP, Attrib.ATTR_DPF_FLOW_RATE, Attrib.ATTR_OIL_PRESSURE, Attrib.ATTR_MALFUNCTION_INDICATOR_LAMP,
                          Attrib.ATTR_CHECK_ENGINE, Attrib.ATTR_ENGINE_HOURS,  Attrib.ATTR_MAINTENANCE_CAPABILITIES}),

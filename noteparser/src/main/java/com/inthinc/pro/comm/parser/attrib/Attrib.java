...
public enum Attrib {
    ...
    ATTR_BATTERY_VOLTAGE(8303,AttribParserType.INTEGER),
    ATTR_ENGINE_TEMP(16471,AttribParserType.INTEGER),
    ATTR_TRANSMISSION_TEMP(16472,AttribParserType.INTEGER),
    ATTR_DPF_FLOW_RATE(16473,AttribParserType.INTEGER),
    ATTR_OIL_PRESSURE(16474,AttribParserType.INTEGER),
    ATTR_MALFUNCTION_INDICATOR_LAMP(32869,AttribParserType.INTEGER),
    ATTR_CHECK_ENGINE(32870,AttribParserType.INTEGER),
    ATTR_ENGINE_HOURS(32868,AttribParserType.INTEGER),
    ATTR_MAINTENANCE_CAPABILITIES(32871,AttribParserType.INTEGER),
...
//	LOCATION(24582, AttribParserType.STRING_FIXED_LENGTH30),
    ...
    MOBILEUNITID(24603, AttribParserType.STRING_VAR_LENGTH),
	// BINARY 

...
public class VehicleServiceExtIntegrationTest extends BaseTest {
    static final String NAME_MODIFIER = "10";
    ...
    public void createTestData() {
        ...
        vehicle1.setVIN(NAME_MODIFIER + "94000000901");
        ...
        vehicle2.setVIN(NAME_MODIFIER + "94000000902");
        ...
        vehicle3.setVIN(NAME_MODIFIER + "94000000903");
    ...
    public void getVehicleByVinTest() {
        for (int i = 1; i <= 3; i++) {
            Response response = vehicleServiceExt.findByVIN(NAME_MODIFIER + "9400000090" + i);
            assertNotNull(response.getEntity());
            Vehicle vehicle = (Vehicle) response.getEntity();
            assertNotNull(vehicle);
            assertEquals(vehicle.getName(), testVehicles.get(i).getName());

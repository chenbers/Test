...
public interface IFTAServiceStateMileageByVehicleMonth {
    ...
    Response getStateMileageByVehicleByMonthWithIftaAndDatesMultiGroup(GroupList groupList, @PathParam("startDate") @DateFormat(DATE_FORMAT) Date startDate,
            @PathParam("endDate") @DateFormat(DATE_FORMAT) Date endDate);
    ...
    @Produces("application/xml")
    @Consumes("application/xml")
    Response getStateMileageByVehicleByMonthWithDatesMultiGroup(GroupList groupList, @PathParam("startDate") @DateFormat(DATE_FORMAT) Date startDate,
            @PathParam("endDate") @DateFormat(DATE_FORMAT) Date endDate);
}

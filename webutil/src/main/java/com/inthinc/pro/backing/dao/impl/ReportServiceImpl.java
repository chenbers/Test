...
public class ReportServiceImpl implements ReportService
{
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getDPctByGT", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getDScoreByDT", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getDTrendByDTC", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getDVScoresByGSE", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getDVScoresByGT", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getGDScoreByGSE", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getGDScoreByGT", useMapper=false)
    ...
    @MethodDescription(description="Returns scores for the specified group and duration. The scores represent the weighted average scores for all drivers in the group and its subgroups.", crudType=CrudType.READ,
    					modelClass=com.inthinc.pro.model.DriveQMap.class)  
    @DAODescription(daoID="rawScoreDAO", daoMethod="getGDTrendByGTC", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getSDScoresByGT", useMapper=false)
    ...
    @DAODescription(daoID="rawScoreDAO", daoMethod="getSDTrendsByGTC", useMapper=false)
    ...
    @MethodDescription(description="Returns a list where each record contains a vehicle, a driver and scores. The driver will be included if the vehicle is currently mapped to a driver.", crudType=CrudType.READ,
    					modelClass=com.inthinc.pro.model.aggregation.DriverVehicleScoreWrapper.class)
    @DAODescription(daoID="rawScoreDAO", daoMethod="getVDScoresByGT", useMapper=false)
    ...
    @MethodDescription(description="Returns a list where each record contains a driver, an optional vehicle and scores.  The vehicle will be included if the driver is mapped to a vehicle.", crudType=CrudType.READ, 
    					modelClass=com.inthinc.pro.model.aggregation.DriverVehicleScoreWrapper.class)  
    @DAODescription(daoID="rawScoreDAO", daoMethod="getVDScoresByGSE", useMapper=false)
    ...
    @MethodDescription(description="Returns the vehicle's scores for the specified duration.", crudType=CrudType.READ,
			modelClass=com.inthinc.pro.model.DriveQMap.class)
    @DAODescription(daoID="rawScoreDAO", daoMethod="getVScoreByVT", useMapper=false)
    ...
    @MethodDescription(description="Returns a list the vehicle scores for the specified aggregation type", crudType=CrudType.READ,
    		modelClass=com.inthinc.pro.model.DriveQMap.class)
    @DAODescription(daoID="rawScoreDAO", daoMethod="getVTrendByVTC", useMapper=false)

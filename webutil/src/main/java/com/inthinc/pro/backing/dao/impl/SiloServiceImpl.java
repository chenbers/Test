...
public class SiloServiceImpl implements SiloService
{
    ...
    @Override
    public Map<String, Object> createAcct(@DaoParam(name="siloID")Integer siloID, @DaoParam(name="Account", type=com.inthinc.pro.model.Account.class)Map<String, Object> acctMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createAddr(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Address", type=com.inthinc.pro.model.Address.class)Map<String, Object> addrMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createDevice(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Device", type=com.inthinc.pro.model.Device.class)Map<String, Object> deviceMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createDriver(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Driver", type=com.inthinc.pro.model.Driver.class)Map<String, Object> driverMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createGroup(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Group", type=com.inthinc.pro.model.Group.class)Map<String, Object> groupMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createPerson(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Person", type=com.inthinc.pro.model.Person.class)Map<String, Object> personMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createRedFlagAlert(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="RedFlagAlert", type=com.inthinc.pro.model.RedFlagAlert.class)Map<String, Object> redFlagAlertMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createTablePref(@DaoParam(name="accountID")Integer userID, @DaoParam(name="TablePreference", type=com.inthinc.pro.model.TablePreference.class)Map<String, Object> tablePrefMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createUser(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="User", type=com.inthinc.pro.model.User.class)Map<String, Object> userMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createVehicle(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Vehicle", type=com.inthinc.pro.model.Vehicle.class)Map<String, Object> vehicleMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createZone(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Zone", type=com.inthinc.pro.model.Zone.class)Map<String, Object> zoneMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> createZoneAlert(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="ZoneAlert", type=com.inthinc.pro.model.ZoneAlert.class)Map<String, Object> zoneAlertMap) throws ProDAOException
    {
        return null;
    }
    ...
    @Override
    public Map<String, Object> queueFwdCmd(@DaoParam(name="deviceID")Integer deviceID, @DaoParam(name="FowardCommand", type=com.inthinc.pro.model.ForwardCommand.class)Map<String, Object> fwdMap)
    {
        return null;
    }
    ...
    @Override
    public Map<String, Object> updateAcct(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="Account", type=com.inthinc.pro.model.Account.class)Map<String, Object> acctMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateAddr(@DaoParam(name="addressID")Integer addrID, @DaoParam(name="Address", type=com.inthinc.pro.model.Address.class)Map<String, Object> addrMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateDevice(@DaoParam(name="deviceID")Integer deviceID, @DaoParam(name="Device", type=com.inthinc.pro.model.Device.class)Map<String, Object> deviceMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateDriver(@DaoParam(name="driverID")Integer driverID, @DaoParam(name="Driver", type=com.inthinc.pro.model.Driver.class)Map<String, Object> driverMap) throws ProDAOException
    {
        return null;
    }
    ...
    @Override
    public Map<String, Object> updateGroup(@DaoParam(name="groupID")Integer groupID, @DaoParam(name="Group", type=com.inthinc.pro.model.Group.class)Map<String, Object> groupMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updatePerson(@DaoParam(name="personID")Integer personID, @DaoParam(name="Person", type=com.inthinc.pro.model.Person.class)Map<String, Object> personMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateRedFlagAlert(@DaoParam(name="redFlagAlertID")Integer redFlagAlertID, @DaoParam(name="RedFlagAlert", type=com.inthinc.pro.model.RedFlagAlert.class)Map<String, Object> redFlagAlertMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateTablePref(@DaoParam(name="tablePrefID")Integer tablePrefID, @DaoParam(name="TablePreference", type=com.inthinc.pro.model.TablePreference.class)Map<String, Object> tablePrefMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateUser(@DaoParam(name="userID")Integer userID, @DaoParam(name="User", type=com.inthinc.pro.model.User.class)Map<String, Object> userMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateVehicle(@DaoParam(name="vehicleID")Integer vehicleID, @DaoParam(name="Vehicle", type=com.inthinc.pro.model.Vehicle.class)Map<String, Object> vehicleMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateZone(@DaoParam(name="zoneID")Integer zoneID, @DaoParam(name="Zone", type=com.inthinc.pro.model.Zone.class)Map<String, Object> zoneMap) throws ProDAOException
    {
        return null;
    }

    @Override
    public Map<String, Object> updateZoneAlert(@DaoParam(name="zoneAlertID")Integer zoneAlertID, @DaoParam(name="ZoneAlert", type=com.inthinc.pro.model.ZoneAlert.class)Map<String, Object> zoneAlertMap) throws ProDAOException
    {
        return null;
    }
    ...
    @Override
    public List<Map<String, Object>> getMessages(@DaoParam(name="siloID")Integer siloID, @DaoParam(name="deliveryMethod",inputDesc="1-PHONE,2-TEXT_MESSAGE,3-EMAIL")Integer deliveryMethodType)
    {
        return null;
    }
...
//rfid - driverID
    ...
    @Override
    public Map<String, Object> createReportPref(@DaoParam(name="accountID")Integer acctID, @DaoParam(name="ReportSchedule", type=com.inthinc.pro.model.ReportSchedule.class)Map<String, Object> reportPrefMap) throws ProDAOException
    {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public Map<String, Object> updateReportPref(@DaoParam(name="reportPrefID")Integer reportPrefID, @DaoParam(name="ReportSchedule", type=com.inthinc.pro.model.ReportSchedule.class)Map<String, Object> reportPrefMap) throws ProDAOException
    {
        return null;
    }

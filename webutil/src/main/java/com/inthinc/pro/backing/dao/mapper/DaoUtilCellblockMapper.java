...
public class DaoUtilCellblockMapper extends BaseUtilMapper {
    ...
    public void cellStatusColumnToCellStatusField(Cellblock cellblock, Object value)
    {
        ...
        if (value instanceof Integer){
            ...
            cellblock.setCellStatus(value.equals(0)?CellStatusType.DISABLED:CellStatusType.ENABLED);
        }
    }
    ...
    {
        if (cellblock == null || value == null || cellblock.getProvider() == null) return;
        
        if (Map.class.isInstance(value))
        {
            ((Map<String, Object>)value).put("providerType",cellblock.getProvider().getCode());
        }

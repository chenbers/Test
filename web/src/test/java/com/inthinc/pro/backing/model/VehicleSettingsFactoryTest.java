...
public class VehicleSettingsFactoryTest {
    private List<SensitivitySliderValues> sensitivitySliderValuesList;
    private SensitivitySliders sensitivitySliders;
    @Before
    public void setupSensitivitySliderValues(){
        
        sensitivitySliderValuesList = new ArrayList<SensitivitySliderValues>();

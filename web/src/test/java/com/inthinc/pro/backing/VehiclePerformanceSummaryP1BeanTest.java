...
public class VehiclePerformanceSummaryP1BeanTest extends BaseBeanTest {
    ...
    public void bean()
    {
        ...
        route.add(new LatLng(32.96458094482422f, -114.12114793701172f ));
        Trip trip = new Trip();
        ...
        List<Zone> zones = zoneHessianDAO.getZones(2);

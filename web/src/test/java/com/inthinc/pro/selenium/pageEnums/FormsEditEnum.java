...
//    HOS_DROPDOWN(null, "//select[@id='select-hos-status']"),
    ...
    MINIMUM_EDIT_NUMERIC_USE_EXPRESSION("Use Expression","//input[@id='property_range_min_expression']"),
    MAXIMUM_EDIT_NUMERIC_USE_EXPRESSION("Use Expression","//input[@id='property_range_max_expression']"),

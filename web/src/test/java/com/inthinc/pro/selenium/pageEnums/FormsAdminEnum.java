...
public enum FormsAdminEnum implements SeleniumEnums {
    ...
    NAME_WORKING_ENTRY("Name", "//table[@id='working-forms-table']/tbody/tr[###]/td[1]"),
    NAME_PUBLISHED_ENTRY("Name", "//table[@id='published-forms-table']/tbody/tr[###]/td[1]"),
    BASE_FORM_ID_WORKING_ENTRY("Base Form ID", "//table[@id='working-forms-table']/tbody/tr[###]/td[2]"),
    BASE_FORM_ID_PUBLISHED_ENTRY("Base Form ID", "//table[@id='published-forms-table']/tbody/tr[###]/td[2]"),
    VERSION_WORKING_ENTRY("Version", "//table[@id='working-forms-table']/tbody/tr[###]/td[3]"),

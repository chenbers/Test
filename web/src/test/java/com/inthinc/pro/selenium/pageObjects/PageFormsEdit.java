...
public class PageFormsEdit extends FormsTables {
    ...
    public class FormsEditCheckBoxes {
        ...
        public CheckBox groupSelected() {
            return new CheckBox(FormsEditEnum.GROUPS_NAV_CHECKBOX);
        }
        
        public CheckBox groupSearched() {
            return new CheckBox(FormsEditEnum.GROUPS_NAV_SEARCHED_CHECKBOX);
        }
    }
    ...
    public class FormsEditLinks {
        ...
        public TextLink firstText() {
            return new TextLink(FormsEditEnum.FIRST_TEXT_ELEMENT);
        }
        
        public TextLink firstDate() {
            return new TextLink(FormsEditEnum.FIRST_DATE_ELEMENT);
        }
        
        public TextLink firstNumeric() {
            return new TextLink(FormsEditEnum.FIRST_NUMERIC_ELEMENT);
        }
        
        public TextLink firstSelectOne() {
            return new TextLink(FormsEditEnum.FIRST_SELECT_ONE_ELEMENT);
        }
        
        public TextLink firstSelectMultiple() {
            return new TextLink(FormsEditEnum.FIRST_SELECT_MULTIPLE_ELEMENT);
        }
    }
    ...
    public class FormsEditTexts {
        ...
        public Text groupName() {
            return new Text(FormsEditEnum.GROUPS_NAV_TEXT);
        }
        
        public Text groupSearchedName() {
            return new Text(FormsEditEnum.GROUPS_NAV_SEARCHED_TEXT);
        }
    }

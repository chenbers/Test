...
public class RouteGetEndpointSteps extends WebSteps {
    ...
    public void givenIRetrieveARouteWithTwoDeliveriesAndALoadActivity() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID2 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1002,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"pickup\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Load product from this area\",\"replacementValues\":{\"LBS.value\":\"1000.0\",\"GAL.value\":\"50.0\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{\"LBS.value\":\"100.0\",\"GAL.value\":\"5.0\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{\"LBS.value\":\"10.0\",\"GAL.value\":\"0.5\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824}]}");    	
    	matched(result, original);
    }
    ...
    public void givenIRetrieveARouteWithTwoDeliveriesALoadAndAPreloadActivity() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID3 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1003,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"pickup\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Load product from this area\",\"replacementValues\":{\"LBS.value\":\"1000.0\",\"GAL.value\":\"50.0\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{\"LBS.value\":\"500.0\",\"GAL.value\":\"25.0\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{\"LBS.value\":\"250.0\",\"GAL.value\":\"12.5\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824},{\"stopID\":41,\"customerName\":\"CUSTOMER_4\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"123 Test Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_4\",\"productKind\":\"PRODUCT_KIND_4\",\"instructions\":\"Preload for tomorrows activities\",\"replacementValues\":{\"LBS.value\":\"125.0\",\"GAL.value\":\"6.25\"},\"status\":0,\"formID\":0,\"plannedArrival\":1362800624,\"plannedDeparture\":1362802424}]}");
    	matched(result, original);
    }
    ...
    public void givenIRetrieveARouteWithTwoDeliveriesAndAPreloadActivity() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID4 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1004,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"pickup\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Preload for tomorrows activities\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824}]}");
    	matched(result, original);
    }
    
    @Given("I retrieve a route with two deliveries")
    public void givenIRetrieveARouteWithTwoDeliveries() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID5 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    ...
    public void givenIRetrieveARouteWithTwoDeliveriesAndAPreloadActivityThenCancelThePreloadActivity() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID6 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1006,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"pickup\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Preload for tomorrows activities\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824}]}");
    	matched(result, original);
    	//TODO: Add code to cancel the preload activity
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID6 + "/" + trailer + "/" + "1");  //for dev
    ...
    public void givenIRetrieveARouteWithTwoDeliveriesAndALoadActivityAndThenLaterAddAPreloadActivity() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID7 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1007,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"pickup\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Load product from this area\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824}]}");
    	matched(result, original);
    	//TODO: Add code to add a preload activity
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID7 + "/" + trailer + "/" + "1");  //for dev
    	original = page._text().response().toString();
    	result = original.equals("{\"routeID\":10071,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"pickup\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Load product from this area\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer 1, they have an entrance in the back\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Deliver to customer 2, they have a silo on the side\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824},{\"stopID\":41,\"customerName\":\"CUSTOMER_4\",\"type\":\"pickup\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"123 Load Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Preload for tomorrows activities\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362800624,\"plannedDeparture\":1362802424}]}");
    	matched(result, original);
    }
    ...
    public void givenIRetrieveARouteWithThreeDeliveriesThenCancelTheSecondDeliveryActivityAndAddANewDeliveryIntoTheThirdDeliverySlot() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID8 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1008,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Deliver to customer A\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer B\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224},{\"stopID\":31,\"customerName\":\"CUSTOMER_3\",\"type\":\"deliver\",\"lat\":38.5482,\"lng\":-97.8008,\"address\":\"123 Test Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_3\",\"productKind\":\"PRODUCT_KIND_3\",\"instructions\":\"Deliver to customer C\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362797024,\"plannedDeparture\":1362798824}]}");
    	matched(result, original);
    ...
    public void givenIRetrieveARouteWithThreeDeliveriesThenCancelAllDeliveryActivitiesAndAddANewDelivery() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID9 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	...
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID9 + "/" + trailer + "/" + "1");  //for dev
    	original = page._text().response().toString();
    	result = original.equals("{\"routeID\":10091,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Deliver to customer D\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624}]}");
    	matched(result, original);
    }    
    ...
    public void givenIRetrieveARouteWithThreeDeliveriesAndTheDriverDeliversThemOutOfOrder() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID10 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    ...
    public void givenIRetrieveARouteWithThreeDeliveriesAndThenIsSentToADumpSite() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID11 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	...
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID11 + "/" + trailer + "/" + "1");  //for dev
    	original = page._text().response().toString();
    	result = original.equals("{\"routeID\":10111,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":46.5482,\"lng\":-95.8008,\"address\":\"123 Dump site, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Drop off remaining product at a dump site\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624}]}");
    	matched(result, original);
    }
    ...
    public void givenIRetrieveARouteAndThenPartiallyCompleteTheRouteAndMoveVehicles() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI2 + "/" + externActionID12 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1012,\"stops\":[{\"stopID\":11,\"customerName\":\"CUSTOMER_1\",\"type\":\"deliver\",\"lat\":36.5482,\"lng\":-95.8008,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_1\",\"productKind\":\"PRODUCT_KIND_1\",\"instructions\":\"Deliver to customer A, then change vehicles\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362789824,\"plannedDeparture\":1362791624},{\"stopID\":21,\"customerName\":\"CUSTOMER_2\",\"type\":\"deliver\",\"lat\":37.5482,\"lng\":-96.8008,\"address\":\"456 Test Delivery, Test City, UT 84222\",\"productCode\":\"PRODUCT_CODE_2\",\"productKind\":\"PRODUCT_KIND_2\",\"instructions\":\"Deliver to customer B\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362793424,\"plannedDeparture\":1362795224}]}");
    	matched(result, original);
    ...
    public void givenIRetrieveARouteAndThenPartiallyCompleteTheRouteAndDifferentDriverRetrievesTheRouteFromTheSameVehicle() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID13 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    ...
    public void givenIRetrieveARouteAndThenPartiallyCompleteTheRouteAndDifferentDriverRetrievesTheRouteFromADifferentVehicle() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI3 + "/" + externActionID14 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    ...
    public void givenICoupleAndDecoupleAtTheSameLocation() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + externActionID15 + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    	boolean result = original.equals("{\"routeID\":1015,\"stops\":[{\"stopID\":201,\"customerName\":\"CUSTOMER_1\",\"type\":\"couple\",\"lat\":33.0088,\"lng\":-117.11,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"OXYG\",\"productKind\":\"OXYGEN\",\"instructions\":\"\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362786224,\"plannedDeparture\":1362786284},{\"stopID\":202,\"customerName\":\"CUSTOMER_1\",\"type\":\"decouple\",\"lat\":33.0088,\"lng\":-117.11,\"address\":\"123 Delivery Street, Test City, UT 84222\",\"productCode\":\"OXYG\",\"productKind\":\"OXYGEN\",\"instructions\":\"\",\"replacementValues\":{},\"status\":0,\"formID\":0,\"plannedArrival\":1362786284,\"plannedDeparture\":1362786344}]}");
    	matched(result, original);
    }
    
    @Given("I provide an invalid IMEI")
    public void givenIProvideAnInvalidIMEI() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + "INVALIDIMEI" + "/" + externActionID + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();
    ...
    public void givenIProvideAnInvalidRouteID() {
    	page.open("https://dev.inthinc.com/forms_service/route/" + IMEI + "/" + "INVALID" + "/" + trailer + "/" + "1");  //for dev
    	String original = page._text().response().toString();

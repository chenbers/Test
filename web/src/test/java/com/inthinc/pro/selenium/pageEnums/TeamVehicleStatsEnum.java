...
public enum TeamVehicleStatsEnum implements SeleniumEnums {
    ...
    TEAM_PERCENT_HEADER("Idle &#37;", "teamStatisticsVehicleForm:drivers:driverTotals:newTeamStatsTab-totalsIdlePercentageheader:sortDiv"),
    ...
    DRIVER_NAME_FILTER("Driver", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-driverNameheader:sortDiv"),
    DRIVER_SCORE_FILTER("Score", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-overallScoreheader:sortDiv"),
    DRIVER_VEHICLE_FILTER("Vehicle", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-vehicleheader:sortDiv"),
    DRIVER_TRIPS_FILTER("Trips", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-tripsheader:sortDiv"),
    DRIVER_STOPS_FILTER("Stops", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-tripStopsheader:sortDiv"),
    DRIVER_DISTANCE_FILTER("Distance Driven", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-milesDrivenheader:sortDiv"),
    DRIVER_DURATION_FILTER("Duration", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-driveTimeheader:sortDiv"),
    DRIVER_IDLE_FILTER("Idle Time", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-idleTimeheader:sortDiv"),
    DRIVER_LOW_FILTER("Low Idle", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-loIdleheader:sortDiv"),
    DRIVER_HIGH_FILTER("High Idle", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-hiIdleheader:sortDiv"),
    DRIVER_PERCENT_FILTER("Idle &#37;", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-idlePercentageheader:sortDiv"),
    DRIVER_FUEL_FILTER("Fuel Eff.", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-mpgheader:sortDiv"),
    DRIVER_CRASHES_FILTER("Crashes", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-crashesheader:sortDiv"),
    DRIVER_SAFETY_FILTER("Safety", "teamStatisticsVehicleForm:drivers:newTeamStatsTab-safetyheader:sortDiv"),

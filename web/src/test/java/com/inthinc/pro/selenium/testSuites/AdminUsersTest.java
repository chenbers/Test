...
import com.inthinc.pro.selenium.steps.StepsAdminAddEditUser;
import com.inthinc.pro.selenium.steps.StepsAdmin;
import com.inthinc.pro.selenium.steps.LoginSteps;

@UsingSteps(instances={LoginSteps.class,StepsAdminAddEditUser.class})
@PageObjects(list={PageLogin.class, 
        PageAdminUsers.class,
        PageAdminUserDetails.class,
        PageAdminAddEditUser.class})
@StoryPath(path="AdminUsers2.story")
...
@StoryPath(path="AdminUsers.story")

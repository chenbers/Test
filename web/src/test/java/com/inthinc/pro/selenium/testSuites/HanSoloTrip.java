...
public class HanSoloTrip {
    ...
    public void hanSolosFirstTrip(String IMEI, Addresses server) {
        tiwi = new TiwiProDevice(IMEI, server);
        tiwi.set_time(1302882600);
        tiwi.set_WMP(17116);
        tiwi.set_location(33.0104, -117.111);
        tiwi.power_on_device();
        tiwi.set_ignition(15);
        tiwi.update_location(33.0104, -117.111, 5);
        tiwi.update_location(33.0104, -117.113, 10);
    ...
    public static void main(String[] args){
        ...
        trip.hanSolosFirstTrip("211596000064778", Addresses.QA);
    }
}

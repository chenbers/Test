...
public class ChangePassword extends WebRallyTest {
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.currentPassword().type(PASSWORD);
	myAccountPage._popUp().changeMyPassword()._textField().newPassword()
		.type(password);
	myAccountPage._popUp().changeMyPassword()._textField()
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().type(password.toLowerCase());
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text()
		.confirmPasswordError()
		.validate("New and Confirm New Password do not match");
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().type(password);
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._text().infoMessage()
		.validate("Password successfully changed");
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.currentPassword().type(PASSWORD);
	myAccountPage._popUp().changeMyPassword()._textField().newPassword()
		.type(random.getMixedString(12));
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().type(random.getMixedString(12));
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text()
		.confirmPasswordError()
		.validate("New and Confirm New Password do not match");
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().type(random.getMixedString(12));
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text().newPasswordError()
		.validate("Required");
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();
	...
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text()
		.confirmPasswordError().validate("Required");
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();
	...
	myAccountPage._popUp().changeMyPassword()._text()
		...
		.validate("Current Password is incorrect");
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();
	...
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text()
		.currentPasswordError().validate("Required");
	myAccountPage._popUp().changeMyPassword()._text().newPasswordError()
		.validate("Required");
	myAccountPage._popUp().changeMyPassword()._text()
		.confirmPasswordError().validate("Required");
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().type(password);
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	if (myAccountPage._popUp().changeMyPassword()._text()
		.newPasswordError().validate("Must be 6 to 12 characters")) {
	    myAccountPage._popUp().changeMyPassword()._button().cancel()
		    .click();
	...
	myAccountPage._popUp().changeMyPassword()._button().change().click();
	myAccountPage._popUp().changeMyPassword()._text().newPasswordError()
		.validate("Must be 6 to 12 characters");
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();
	...
	myAccountPage._popUp().changeMyPassword()._textField()
		.currentPassword().assertVisibility(true);
	myAccountPage._popUp().changeMyPassword()._textField().newPassword()
		.assertVisibility(true);
	myAccountPage._popUp().changeMyPassword()._textField()
		.confirmNewPassword().assertVisibility(true);
	myAccountPage._popUp().changeMyPassword()._button().change()
		.assertVisibility(true);
	myAccountPage._popUp().changeMyPassword()._button().cancel()
		.assertVisibility(true);
	myAccountPage._popUp().changeMyPassword()._button().cancel().click();

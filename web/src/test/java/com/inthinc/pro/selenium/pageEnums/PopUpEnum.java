...
public enum PopUpEnum implements SeleniumEnums {
    ...
    /* Forms Options PopUp */
	OPTIONS_EDITOR_LABEL("Options Editor", "//div[@class='modal optionsEditorDialog jqmID6']/h3"),
	...
	OPTIONS_LABEL("Options", "//div[13]/div[1][@class='modalContents']/h4[2]"),
	UNDERLYING_VALUE_LABEL("Underlying Value", "//ul[@class='optionsHeader clearfix']/li[1]"),
	OPTION_ENGLISH_FIELD(null, "//li[@data-lang='value']/input[###]"),//needs additional work to point to the right field
	OPTION_UNDERLYING_VALUE_FIELD(null, "//li[@data-lang='eng']/input[###]"),//needs additional work to point to the right field

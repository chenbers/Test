...
public class PageAddEditUser extends AdminBar {
	...
	public TextFieldLabel driverLabel(AdminUsersEntries label) {
	    return new TextFieldLabel(AdminAddEditUserEnum.TEXT_FIELDS,
		    "driver_", label);
	}
	...
	public TextFieldError driverError(AdminUsersEntries label) {
	    return new TextFieldError(AdminAddEditUserEnum.TEXT_FIELDS,
		    "driver_", label);
	}
	...
	public TextField driverFields(AdminUsersEntries textField) {
	    return new TextField(AdminAddEditUserEnum.TEXT_FIELDS, "driver_",
		    textField);
	}

	public TextField userFields(AdminUsersEntries textField) {
	    return new TextField(AdminAddEditUserEnum.TEXT_FIELDS, "user_",
		    textField);
	}
    }
	...
	private SeleniumEnums[] enums = {
		AdminAddEditUserEnum.USER_GROUP_DHX,
		AdminAddEditUserEnum.DRIVER_TEAM_DHX
	};

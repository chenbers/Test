...
public class ReportsDevices extends WebRallyTest {
	...
	public void DeviceReportEditColumnsChange() {
		...
		boolean originallyHadGroupColumnID = device._link().deviceIDSort().isPresent();
		boolean originallyHadGroupColumnVehicle = device._link().assignedVehicleSort().isPresent();
		boolean originallyHadGroupColumnIMEI = device._link().imeiSort().isPresent();
		boolean originallyHadGroupColumnPhone = device._link().devicePhoneSort().isPresent();
		boolean originallyHadGroupColumnStatus = device._dropDown().status().isPresent();
		...
		if(originallyHadGroupColumnID !=device._link().deviceIDSort().isPresent()){addError("expected DeviceID column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnVehicle !=device._link().assignedVehicleSort().isPresent()){addError("expected Vehicle column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnIMEI !=device._link().imeiSort().isPresent()){addError("expected IMEI column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnPhone !=device._link().devicePhoneSort().isPresent()){addError("expected Device Phone column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnStatus !=device._dropDown().status().isPresent()){addError("expected Status column to remain the same", ErrorLevel.ERROR);
		}
	...
	public void DeviceReportEditColumnsRetention() {
		...
		if(originallyHadGroupColumnID ==device._link().deviceIDSort().isPresent()){addError("expected DeviceID column to be different", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnVehicle !=device._link().assignedVehicleSort().isPresent()){addError("expected Vehicle column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnIMEI ==device._link().imeiSort().isPresent()){addError("expected IMEI column to be different", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnPhone !=device._link().devicePhoneSort().isPresent()){addError("expected Device Phone column to remain the same", ErrorLevel.ERROR);
		}
		if(originallyHadGroupColumnStatus ==device._dropDown().status().isPresent()){addError("expected Status column to be different", ErrorLevel.ERROR);
		}

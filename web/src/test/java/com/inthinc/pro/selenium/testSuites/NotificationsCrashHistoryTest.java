...
import com.inthinc.pro.selenium.pageObjects.PageNotificationsCrashReport;
...
@PageObjects(list={PageLogin.class, PageExecutiveDashboard.class, PageNotificationsCrashHistory.class, PageNotificationsCrashReport.class,

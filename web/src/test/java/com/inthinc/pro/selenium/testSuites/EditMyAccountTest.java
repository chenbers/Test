...
public class EditMyAccountTest extends WebRallyTest {
	...
	// Rally: Input
	/*
	 * 1. If necessary, click My Account then click Edit. 2. Clear all
	 * possible fields. 3. Click Save.
	 */
	myAccountPage.loginProcess(USERNAME, PASSWORD);
	myAccountPage._link().myAccount().click();
	...
	myAccountPage._text().errorPhone1()
		.validate("What is the minimum number of characters???");// TODO:
									 // dtanner:
									 // to
									 // whomever,
									 // what
	...
	badTextMessageAddresses.add("8015551234@domain@domain.com"); // NOTE:
								     // this is
								     // defect
								     // 6654
	badTextMessageAddresses.add(random.getIntString(5) + "@domain.com"); // phone
									     // number
									     // is
									     // to
									     // short
	badTextMessageAddresses.add("8015551234 @domain.com"); // contains a
							       // space
	badTextMessageAddresses.add("801555\"1234\"@domain.com"); // has quotes
								  // inside
	badTextMessageAddresses
		.add(random.getSpecialString(10) + "@domain.com"); // Special
								   // Characters
								   // for number
	badTextMessageAddresses.add("801362judi@domain.com"); // contains
							      // letters
	...
	for (String address : badTextMessageAddresses) {
	    ...
	    myAccountPage._textField().textMessage2().type(address); // NOTE:
								     // there
								     // might be
								     // an
								     // additional
								     ...
								     // vice
								     // versa)
	    myAccountPage._button().save().click(); // NOTE: IF one of these
						    // "saves" is successful, it
						    // will cause subsequent
						    // iterations of this loop
						    // to FAIL (because we will
						    // NOT be on the Edit page
						    // any longer)

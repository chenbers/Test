...
public enum DriverPerformanceTripsEnum implements SeleniumEnums {
	...
	UPDATE_DATE_RANGE("Update Date Range", "dateForm:driverTripsDate"),
	...
	VEHICLE_NAME(null, "selectVehicleForm:driverTripsVehiclePerformance"),
    ...
    private DriverPerformanceTripsEnum(String url){
    	this.url = url;
    }
    private DriverPerformanceTripsEnum(String text, String ...IDs){
        this.text=text;
    	this.IDs = IDs;
    }

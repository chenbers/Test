...
public enum LoginEnum implements SeleniumEnums {
    ...
    FORGOT_MESSAGE("Enter the e-mail address from your tiwiPro account. Information pertaining to your user name and password will be sent to this e-mail account.", null,
            "//table[@id='forgotPasswordPanelContentTable']/tbody/tr[2]/td/div", null),
    ...
    SECOND_PARAGRAPH("Your user name is indicated below. To change your password, enter a new password in the fields below.", null, "//form[@id='updateCredentialsForm']/p", null),

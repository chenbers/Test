...
@PageObjects(list={PageLogin.class, PageExecutiveDashboard.class, PageAdminUsers.class, PageReportsVehicles.class})
...
//@Ignore
//public class ReportsVehiclesTest extends WebRallyTest {

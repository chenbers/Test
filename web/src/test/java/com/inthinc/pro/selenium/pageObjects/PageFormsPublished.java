...
//         checkMe.add(FormsPublishedEnum.EDIT_ENTRY);
    ...
    public class FormsPublishedButtons {
        ...
        public Button closeMessage() {
            return new Button(FormsPublishedEnum.CLOSE_SUCCESSFULLY_PUBLISHED_BUTTON);
        }
    }
    ...
    public class FormsPublishedTexts {
        ...
        public Text successfullyPublishedMessage() {
            return new Text(FormsPublishedEnum.SUCCESSFULLY_PUBLISHED_MESSAGE);
        }
    }

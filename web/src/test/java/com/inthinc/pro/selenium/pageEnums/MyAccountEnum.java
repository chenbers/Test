...
public enum MyAccountEnum implements SeleniumEnums {
    ...
    NAME_TITLE("Name:", "//td[contains(@style,'top')][1]/table/tbody/tr[1]/td[1]"),
    NAME_TEXT(null, "//td[contains(@style,'top')][1]/table/tbody/tr[1]/td[2]"),
    GROUP_TITLE("Group:", "//td[contains(@style,'top')][1]/table/tbody/tr[2]/td[1]"),
    GROUP_TEXT(null, "//td[contains(@style,'top')][1]/table/tbody/tr[2]/td[2]"),
    TEAM_TITLE("Team:", "//td[contains(@style,'top')][1]/table/tbody/tr[3]/td[1]"),
    TEAM_TEXT(null, "//td[contains(@style,'top')][1]/table/tbody/tr[3]/td[2]"),

...
public class PageFormsAdd extends FormsTables {
    ...
    public class FormsAddCheckBoxes {
        ...
        public CheckBox minimumNumericUseExpression() {
            return new CheckBox(FormsAddEnum.MINIMUM_ADD_NUMERIC_USE_EXPRESSION);
        }
        
        public CheckBox maximumNumericUseExpression() {
            return new CheckBox(FormsAddEnum.MAXIMUM_ADD_NUMERIC_USE_EXPRESSION);
        }
        ...
        public CheckBox groupSelected() {
            return new CheckBox(FormsAddEnum.GROUPS_NAV_CHECKBOX);
        } // debug
        
        public CheckBox groupSearched() {
            return new CheckBox(FormsAddEnum.GROUPS_NAV_SEARCHED_CHECKBOX);
        } // debug
    }
    ...
    public class FormsAddLinks {
        ...
        public TextTableLink deleteRow() {
            return new TextTableLink(FormsAddEnum.DELETE_ROW);
        }
    ...
    protected boolean checkIsOnPage() {
        return _textField().name().isPresent() && _textField().filterGroups().isPresent();
    }
}

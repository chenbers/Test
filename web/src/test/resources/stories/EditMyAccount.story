...
And I save the Fuel Efficiency Team Total text as DFE1
And I click the Vehicle Statistics link
And I click the 365 Days link
And I save the Fuel Efficiency Team Total text as DFE2
And I click the My Account link
And I click the Edit button
And I select "English" from the Measurement dropdown
And I click the Save button
...
And I click the Driver Statistics link
And I click the 365 Days link
And I validate the Fuel Efficiency Team Total text is not DFE1
And I click the Vehicle Statistics link
And I click the 365 Days link
And I validate the Fuel Efficiency Team Total text is not DFE2
...
Given I am logged in as a "Admin" user
When I click the My Account link
And I save the Information text as origInfodd
And I save the Warning text as origWarndd
And I save the Critical text as origCritdd
And I save the Map Type text as origMapTypedd
And I save the Map Layers text as origMapLayersdd
And I save the Locale text as origLocaledd
And I save the Measurement text as origMeasurementdd
And I save the Fuel Efficiency Ratio text as origFERdd
And I save the Email1 text as origEmail1
And I save the Email2 text as origEmail2
And I save the Phone1 text as origPhone1
And I save the Phone2 text as origPhone2
And I save the Text Message1 text as origTextMessage1
And I save the Text Message2 text as origTextMessage2
And I click the Edit button
And I select text that contains "E-mail 1" from the Information drop down
And I select text that contains "E-mail 2" from the Warning drop down
And I select text that contains "Phone 1" from the Critical drop down

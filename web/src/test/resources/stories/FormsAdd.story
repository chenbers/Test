...
And I type "Hint" into the Hint textfield
And I type "0000" in the Default Value textfield
And I check the Range checkbox
And I check the Minimum Range Inclusive checkbox
And I check the Maximum Range Inclusive checkbox
And I type "1" into the Minimum Range textfield
And I type "5" into the Maximum Range textfield
And I type "Value out of range" into the Invalid Text textfield
And I click Save Top button
Then I validate the new form displays in the list on the Admin Form page
...
When I click the Forms link
And I click the Create Form link
And I click the Numeric textfield link
And I type "an XML tag" into the Data Name textfield 
And I type “Unit” into the Caption Text textfield
And I type "Hint" into the Hint textfield
And I type "2" in the Default Value textfield
And I check the Required checkbox
And I check the Range Enable checkbox
And I type "1" into the Minimum Range textfield
And I type "3" into the Maximum Range textfield
And I click Save Top button
Then I validate the new form displays in the list on the Admin Form page

Scenario: TCXXXX ODK Add a Numeric Field with Range minimum - Inclusive
Given I am logged in
When I click the Forms link
And I click the Create Form link
And I click the Numeric textfield link
...
And I type “Unit” into the Caption Text textfield
And I type "Hint" into the Hint textfield
And I type "2" into the Default Value textfield
And I check the Required checkbox
And I check the Range Enable checkbox
And I check the Minimum Range Inclusive checkbox
And I check the Maximum Range Inclusive checkbox
...
And I type "Hint" into the Hint textfield
And I select today from the Default Value dropdown
And I check the Read Only checkbox
And I click Save Top button
Then I validate the new form displays in the list on the Admin Form page
...
And I check the Minimum Range Inclusive checkbox
And I check the Maximum Range Inclusive checkbox
And I select today from the Minimum Range dropdown
And I select 7 days in the past from the Maximum Range dropdown
And I type "Value out of range" into the Invalid Text textfield
And I click Save Top button
Then I validate the new form displays in the list on the Admin Form page
And when I try to enter a value outside the required range the "Value out of range" error message appears
...
Scenario: TCXXXX ODK Add a Choose One Field - Required box unchecked
Given I am logged in
When I click the Forms link
And I click the Create Form link
And I click the Choose One link
...
And I type "Hint" into the Hint textfield
And I type "Default Value" in the Default Value textfield
And I uncheck the Required checkbox
And I click the Add Option link
And I type "Option 1" in the 1st Option textfield
And I type "optionone" in the 1st Underlying Value textfield
And I click the Add Option link
...
And I click the Save Top button
Then I validate the new form displays in the list on the Admin Form page
And I validate all 30 options show up on the form

Scenario: TCXXXX ODK Add a Select Multiple Field - Read Only box checked
Given I am logged in
When I click the Forms link
And I click the Create Form link
And I click the Select Mutliple link
And I type "an XML tag" into the Data Name textfield
And I type “Choose One” into the Caption Text textfield
And I type "Hint" into the Hint textfield
And I type "Default Value" in the Default Value textfield
...
Scenario: TCXXXX ODK Add a Select Multiple Field - Required box unchecked
Given I am logged in
When I click the Forms link
And I click the Create Form link
And I click the Select Mutliple link

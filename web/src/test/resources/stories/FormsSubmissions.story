...
Scenario: TCXXXX Forms Submissions Page - Forms Blank Table Message
Given I am logged in
When I go to the forms submissions page
...
Given I am logged in
When I go to the forms submissions page
And I select "Past Year" from the Date dropdown
...
Scenario: TCXXXX Forms Submissions Page - Cancel Approved (Change back to Submitted)
Given I am logged in
When I go to the forms submissions page
And I select "Past Year" from the Date dropdown
And I click the Refresh button

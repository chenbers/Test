...
public class DateLabels {
	...
	{
	    dayFormatter = new SimpleDateFormat(MessageUtil.getMessageString("justDay"), locale);
		dayFormatter.setTimeZone(TimeZone.getTimeZone("GMT"));
	    monthDayFormatter = new SimpleDateFormat(MessageUtil.getMessageString("monthDay"), locale);

...
public class SBSChangeRequest implements EditItem, Serializable {
    ...
    public void setStreetSegment(String tigerLine) {
        ...
        streetSegmentPoints = new ArrayList<Point>();
        tigerLine = tigerLine.substring("MULTILINESTRING((".length(), tigerLine.length() - 2);
        String[] points = tigerLine.split(",");
        for (String point1 : points) {

            Double lng1 = Double.parseDouble(point1.substring(0, point1.indexOf(" ")));
            Double lat1 = Double.parseDouble(point1.substring(point1.indexOf(" ")));
    ...
    public boolean isKilometersPerHour() {
        return isKilometersPerHour;
    }

    public void setKilometersPerHour(boolean isKilometersPerHour) {
        this.isKilometersPerHour = isKilometersPerHour;
    }
    ...
    public void setAddress(String fromAddrRight, String toAddrRight, String fromAddrLeft, String toAddrLeft, String fedirp, String st_typ_bef, String fename, String st_nm_suff, String fetype,
            String fedirs, int inAddress) {

        List<String> processedAddress = makeAddress(fromAddrRight, toAddrRight, fromAddrLeft, toAddrLeft, fedirp, st_typ_bef, fename, st_nm_suff, fetype, fedirs, inAddress);

        address = processedAddress.get(1);
    }

    public void setAddress(String fromAddrRight, String fedirp, String st_typ_bef, String fename, String st_nm_suff, String fetype, String fedirs, int inAddress) {
    ...
    private List<String> makeAddress(String fromAddrRight, String toAddrRight, String fromAddrLeft, String toAddrLeft, String fedirp, String st_typ_bef, String fename, String st_nm_suff,
            String fetype, String fedirs, int address) {

...
public class TrendFlyoutBean extends BaseBean {
    ...
    private String createLineDef() {
        ...
        Map<Integer, List<ScoreableEntity>> groupTrendMap = scoreDAO.getTrendScores(this.navigation.getGroupID(), navigation.getDurationBean().getDuration());
...
//            }
    ...
    public String getCountString() {
        countString = "Showing " + this.start + " to " + this.end + " of " + this.maxCount + " records";
        return countString;
    }

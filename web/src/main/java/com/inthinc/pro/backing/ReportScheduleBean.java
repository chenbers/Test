...
public class ReportScheduleBean extends BaseAdminBean<ReportScheduleBean.ReportScheduleView> implements TablePrefOptions<ReportScheduleBean.ReportScheduleView>, Serializable {
    ...
    protected List<ReportScheduleView> loadItems() {
        ...
        if (getProUser().isAdmin())
            ...
            reportScheduleList = reportScheduleDAO.getReportSchedulesByUserID(getProUser().getUser().getUserID());
    ...
    private ReportScheduleView completeReportScheduleView(ReportSchedule reportSchedule, ReportScheduleView reportScheduleView) {
        ...
        String[] ignoreProperties = { "fullName" };
        BeanUtils.copyProperties(reportSchedule, reportScheduleView,ignoreProperties);
        if(reportScheduleView.getFullName() == null){
            reportScheduleView.setFullName(reportSchedule.getFullName());
        }

...
public class ReportRendererBean extends BaseBean implements ReportRenderer
{
    ...
    public void exportOverallScoreToPDF(List<PieScoreData> overallScoreData
            ...
            List<PieScoreData> speedData,String overallscore)
    {
        ...
        //TODO bring in real account name
        paramMap.put("ACCOUNT_NAME", "Test Account");
    ...
    public void exportTrendReportToPDF(List<LineGraphData> trendChartData, List<ScoreableEntityPkg> scoreableEntityData)
    {
        ...
        //TODO removed hard coded account
        paramMap.put("ACCOUNT_NAME", "Test Account");
        JasperPrint jp = proCompiler.compileReport(source,paramMap);
        exportToPdf(jp);
    }

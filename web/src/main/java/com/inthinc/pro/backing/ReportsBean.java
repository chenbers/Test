    ...
    protected void genReportCriteria()
    {
        ...
        switch (reportGroup.getReports()[0]) {
            ...
            case DRIVER_EXCLUDED_VIOLATIONS:
                ...
                break;
            case NON_COMM:
                reportCriteriaList.add(getReportCriteriaService().getNonCommReportCriteria(getAccountGroupHierarchy(),params.getGroupID(),params.getTimeFrameSelect().getTimeFrame(),params.getDateRange().getInterval(), getLocale(),getDateTimeZone()));
                break;
            case DVIR_PRETRIP:

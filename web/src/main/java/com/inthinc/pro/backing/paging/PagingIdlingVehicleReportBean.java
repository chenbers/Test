...
import com.inthinc.pro.table.model.provider.IdlingVehicleReportPaginationTableDataProvider;
import com.inthinc.pro.util.MessageUtil;
@KeepAlive
public class PagingIdlingVehicleReportBean extends BasePagingReportBean<IdlingReportItem>
{

	private static final long serialVersionUID = -6262432712330539230L;
	private static final Logger logger = Logger.getLogger(PagingIdlingVehicleReportBean.class);
    ...
    public Integer getTotalDrivers() {
		return ((IdlingVehicleReportPaginationTableDataProvider)getTableDataProvider()).getTotalDrivers();
	}

    public Integer getTotalEMUDrivers(){
		return ((IdlingVehicleReportPaginationTableDataProvider)getTableDataProvider()).getTotalDriversWithIdleStats();
	}
    ...
    public void refreshAction() {
		...
		if (interval != null) {
			((IdlingVehicleReportPaginationTableDataProvider)getTableDataProvider()).setInterval(interval);
			getTable().reset();
    ...
    public void searchAction()
    {
		...
		if (interval == null) {
	        ...
	        ((IdlingVehicleReportPaginationTableDataProvider)getTableDataProvider()).setInterval(initInterval());
		}
    	getTable().reset();
    ...
    {
    	ReportCriteria reportCriteria =  getReportCriteriaService().getIdlingVehicleReportCriteria(getTableDataProvider().getGroupID(), ((IdlingVehicleReportPaginationTableDataProvider)getTableDataProvider()).getInterval(), getLocale(), false);

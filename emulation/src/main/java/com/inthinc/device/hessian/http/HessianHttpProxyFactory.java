package com.inthinc.device.hessian.http;
...
import com.inthinc.device.hessian.http.CookieParser.Cookie;
...
public class HessianHttpProxyFactory extends HessianProxyFactory {
    ...
    public <T> T create(Addresses server) throws MalformedURLException {
    	ClassLoader loader = Thread.currentThread().getContextClassLoader();
        InvocationHandler handler = new HessianHttpProxy(this, new URL("https://" + server.getMCMUrl() + ":7443/"));
        return (T) Proxy.newProxyInstance(loader, new Class[]{MCMService.class, HessianRemoteObject.class}, handler);
    }

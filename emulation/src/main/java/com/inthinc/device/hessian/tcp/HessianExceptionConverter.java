...
public class HessianExceptionConverter
{
    ...
    static
    {
        ...
        HESSIAN_EXCEPTION_MAP.put(229, "HessianExpectNull....   Encountered something other than the expected Hessian 'Null' object.");
        ...
        HESSIAN_EXCEPTION_MAP.put(340, "TSCodeDuplicateCrash.   An attempt to create a duplicate crash.");
        HESSIAN_EXCEPTION_MAP.put(341, "TSCodeSystem.........   ???");
        HESSIAN_EXCEPTION_MAP.put(342, "TSCodeDuplicateDriver   An attempt to create another driver for personID.");
        ...
        HESSIAN_EXCEPTION_MAP.put(346, "TSCodeDuplicateMcmid.   An attempt to use an existing mcmid.");
        HESSIAN_EXCEPTION_MAP.put(347, "TSCodeDuplicateAltImei  An attempt to use an existing altImei.");

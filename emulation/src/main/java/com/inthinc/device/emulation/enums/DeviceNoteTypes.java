...
public enum DeviceNoteTypes  {
    ...
    DRIVERSTATE_CHANGE(40, EventAttr.CLEAR_DRIVER_FLAG, EventAttr.TRIP_REPORT_FLAG, EventAttr.TRIP_INSPECTION_FLAG, EventAttr.CLEAR_DRIVER_FLAG_WHAT, EventAttr.DRIVER_STR, EventAttr.LOCATION, EventAttr.DRIVER_HOS_STATE),
    ENDOFMONTH(41),
    TIMESTAMP(42),
    HOS_RECEIVED(43),
    LOCATIONDEBUG(44),
    ...
    DRIVERSTATE_CHANGE_EX(96, EventAttr.DRIVER_HOS_STATE, EventAttr.CLEAR_DRIVER_FLAG, EventAttr.DRIVER_STR),
    LIGHT_DUTY(97),
    HEAVY_DUTY(98),
    MISSING_IWI_CONF(99),
    ...
    A_AND_D_SPACE___HOS_CHANGE_STATE_NO_GPS_LOCK(113, EventAttr.DRIVER_HOS_STATE, EventAttr.CLEAR_DRIVER_FLAG, EventAttr.DRIVER_STR, EventAttr.LOCATION),

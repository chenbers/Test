...
/****************************************************************************************
 * Purpose: To catch the errors raised by Selenium, and format them into a nice
 * HashMap<br />
 * <p>
...
public class ErrorCatcher implements InvocationHandler {
	...
	return (CoreMethodInterface) Proxy.newProxyInstance(delegate.getClass()
		.getClassLoader(), getInterfaces(delegate.getClass()), this);
    }

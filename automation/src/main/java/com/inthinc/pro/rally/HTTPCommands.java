...
public class HTTPCommands {
	 ...
	 * Depending on the status, print an error or success method, consume the
	 * body<br />
	...
	/**
	 * Get the Query Result from Rally. Objects have the form JSONObject >

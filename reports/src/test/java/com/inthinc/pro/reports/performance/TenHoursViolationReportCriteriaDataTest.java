...
public class TenHoursViolationReportCriteriaDataTest extends BaseUnitTest {
    ...
    TenHoursViolation[] expectedData = {
        new TenHoursViolation("Norman Wells->Norman Wells - WS",new Date(1278223200000l),"Francey,  David ","","02289734",3.0833333333333335),
        new TenHoursViolation("Norman Wells->Norman Wells - WS",new Date(1278309600000l),"Francey,  David ","","02289734",3.5166666666666666),
        new TenHoursViolation("Norman Wells->Norman Wells - WS",new Date(1277964000000l),"Giem,  Scott","","00317263",3.433333333333333),
    };

...
public class DotHoursRemainingReportCriteriaTest extends BaseUnitTest {
    ...
    DotHoursRemaining dotHoursRemainingExpectedData[][] = {
    {
        ...
        new DotHoursRemaining("Open Hole",0,"Wilkerson,  Jason M",RuleSetType.US_OIL,0l,1940l,"07/23/10",new Date(1279864800000l),HOSStatus.DRIVING,75l),
        new DotHoursRemaining("Open Hole",0,"Wilkerson,  Jason M",RuleSetType.US_OIL,0l,1940l,"07/23/10",new Date(1279864800000l),HOSStatus.ON_DUTY,405l),

...
public class DotHoursRemainingReportCriteriaTest extends BaseUnitTest {
    ...
    DotHoursRemaining dotHoursRemainingExpectedData[][] = {
    {
        ...
        new DotHoursRemaining("Open Hole",0,"Davis,  Rod",RuleSetType.US_OIL,212l,563l,"08/06/10",new Date(1281074400000l),HOSStatus.DRIVING,495l),//510l),
        new DotHoursRemaining("Open Hole",0,"Davis,  Rod",RuleSetType.US_OIL,212l,563l,"08/06/10",new Date(1281074400000l),HOSStatus.ON_DUTY,30l), //15l),
        ...
        new DotHoursRemaining("Open Hole",0,"Davis,  Rod",RuleSetType.US_OIL,212l,563l,"07/23/10",new Date(1279864800000l),HOSStatus.DRIVING,660l), //645l),
        new DotHoursRemaining("Open Hole",0,"Davis,  Rod",RuleSetType.US_OIL,212l,563l,"07/23/10",new Date(1279864800000l),HOSStatus.ON_DUTY,240l), //255l),
        ...
        new DotHoursRemaining("Open Hole",0,"Gilbert,  Justin T",RuleSetType.US_OIL,295l,2685l,"08/05/10",new Date(1280988000000l),HOSStatus.ON_DUTY,435l),

...
public class DVIRViolationReportCriteriaTest extends BaseUnitTest{
	...
	private List<ReportCriteria> runTestReport(Integer groupId,int caseCount, final int recCount, final boolean nullOutUnsafeList,
			final boolean nullOutPreTripList, final boolean nullOutPostTripViolation) {
//		creatViolationReportTestData(recCount, nullOutUnsafeList, nullOutPreTripList, nullOutPostTripViolation);
	...
	private List<DVIRViolationReport> creatViolationReportTestData(int recCount, boolean nullOutUnsafeList,
			boolean nullOutPreTripList, boolean nullOutPostTripViolation) {

...
public class PayrollCriteriaTest extends BaseUnitTest {
    ...
    PayrollData payrollDataExpectedData[] = {
        ...
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",1,"Francey,  David ","02289734",new Date(1278050400000l),HOSStatus.ON_DUTY,45),
        ...
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",1,"Francey,  David ","02289734",new Date(1278396000000l),HOSStatus.ON_DUTY,210),
        ...
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",2,"Giem,  Scott","00317263",new Date(1278396000000l),HOSStatus.OFF_DUTY,345),
        ...
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",3,"Harris,  Eugene","01041730",new Date(1278396000000l),HOSStatus.OFF_DUTY,465),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",3,"Harris,  Eugene","01041730",new Date(1278396000000l),HOSStatus.OFF_DUTY,15),
        ...
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.OFF_DUTY,15),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.DRIVING,15),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.ON_DUTY,90),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.ON_DUTY,15),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.ON_DUTY,15),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.ON_DUTY,15),
        new PayrollData("Norman Wells->Norman Wells - WS","123 Norman Wells - WS, City, UT, 12345",6,"Szpuniarski,  James","01466044",new Date(1278482400000l),HOSStatus.ON_DUTY,15),
    ...
    String tabularPayrollDetailsExpectedData[][] = {
            ...
            {"Francey,  David ", "07/07/2010", "21:30", "00:00", "00:00", "00:45", "02:00", "02:45",   },
            {"Giem,  Scott", "07/01/2010", "15:45", "00:00", "00:00", "03:15", "05:00", "08:15",   },

...
public class ThirtyMinuteBreaksReportCriteriaTest {
    ...
    public void testInit() {
        ...
        final ThirtyMinuteBreaksReportCriteria sut = new ThirtyMinuteBreaksReportCriteria(mockLocale);
...
//    
    ...
    public void testCompileBreakData() {
        ...
        ThirtyMinuteBreaksReportCriteria sut = new ThirtyMinuteBreaksReportCriteria(mockLocale);

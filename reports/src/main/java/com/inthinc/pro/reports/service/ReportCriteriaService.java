...
public interface ReportCriteriaService
{
    ...
    ReportCriteria getDriverPerformanceWeeklyReportCriteria(GroupHierarchy accountGroupHierarchy, List<Integer> groupIDList, TimeFrame timeFrame, Locale locale, MeasurementType measurementType);

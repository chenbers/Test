...
public abstract class ViolationsReportCriteria extends ReportCriteria {

    private static final Logger logger = Logger.getLogger(ViolationsReportCriteria.class);
    
    protected DateTimeFormatter dateTimeFormatter;
    
    public ViolationsReportCriteria(ReportType reportType, Locale locale) 
    {

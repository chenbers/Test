...
public enum ReportType
{
    ...
    DRIVER_PERFORMANCE_KEY_METRICS("Driver Performance Key Metrics","driverPerformanceKeyMetricsRYG.jrxml","driverPerformanceKeyMetricsRYG.jrxml", "performance","com.inthinc.pro.reports.jasper.performance.i18n.driverPerformanceKeyMetrics", null, true),//TODO: jwimmer this one needs NO RYG the one below needs BOTH(IF excel will pick up backcolors?!)
    DRIVER_PERFORMANCE_KEY_METRICS_TF("Driver Performance Key Metrics Time Frame","driverPerformanceKeyMetricsRYG.jrxml","driverPerformanceKeyMetrics.jrxml", "performance","com.inthinc.pro.reports.jasper.performance.i18n.driverPerformanceKeyMetrics", null, true),

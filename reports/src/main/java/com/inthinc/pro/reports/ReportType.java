...
public enum ReportType
{
    ...
    BREAK_REPORT("Break Report (0-2 hrs.)","breakReport.jrxml", "breakReportRaw.jrxml", "performance", "com.inthinc.pro.reports.jasper.performance.i18n.breakReport", null, true),

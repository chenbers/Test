...
public class DVIRViolationReportCriteria extends ReportCriteria{
	...
	public static class Builder{
        ...
        public DVIRViolationReportCriteria build(){
        	...
        	List<DVIRViolationReport> dvirViolationList = 
        			(List<DVIRViolationReport>)dvirViolationDao.getDVIRViolationsForGroup(this.groupIDs, this.timeFrame.getInterval());

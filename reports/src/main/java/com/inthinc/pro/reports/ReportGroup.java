...
public enum ReportGroup {
    ...
    /* Communication */
    NON_COMM("Vehicles Not Communicating Report", 27, EntityType.ENTITY_GROUP, new CriteriaType[] { CriteriaType.TIMEFRAME_STRICT,CriteriaType.DONT_INCLUDE_UNASSIGNED_DEVICE }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET,

...
public enum ReportGroup {
    ...
    DRIVER_PERFORMANCE_KEY_METRICS("Driver Performance Key Metrics", 38, EntityType.ENTITY_GROUP_LIST, new CriteriaType[] { CriteriaType.TIMEFRAME_ALT }, new GroupType[] { GroupType.DIVISION,

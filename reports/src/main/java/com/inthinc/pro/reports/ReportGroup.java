...
public enum ReportGroup {
    ...
    DRIVERS_REPORT("Driver Report", 2, EntityType.ENTITY_GROUP, new CriteriaType[] { CriteriaType.DURATION, CriteriaType.INACTIVE_AND_ZERO_MILES }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET, GroupType.TEAM },
    ...
    DRIVER_PERFORMANCE_INDIVIDUAL("Driver Performance (Individual)", 35, EntityType.ENTITY_INDIVIDUAL_DRIVER, new CriteriaType[] { CriteriaType.TIMEFRAME, CriteriaType.INACTIVE_AND_ZERO_MILES }, new GroupType[] { GroupType.DIVISION,
    ...
    DRIVER_PERFORMANCE_RYG_INDIVIDUAL("Driver Performance RYG (Individual)", 37, EntityType.ENTITY_INDIVIDUAL_DRIVER, new CriteriaType[] { CriteriaType.TIMEFRAME, CriteriaType.INACTIVE_AND_ZERO_MILES },
    ...
    DRIVER_PERFORMANCE_KEY_METRICS_TF_RYG("Driver Performance Key Metrics Time Frame RYG", 45, EntityType.ENTITY_GROUP_LIST, new CriteriaType[] { CriteriaType.TIMEFRAME_ALT_PLUS_CUSTOM_RANGE, CriteriaType.INACTIVE_AND_ZERO_MILES },
            new GroupType[] { GroupType.DIVISION, GroupType.FLEET, GroupType.TEAM }, ReportCategory.DriverPerformance, EnumSet.of(ReportAccountType.PERFORMANCE),

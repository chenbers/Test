...
public enum ReportGroup
{
    ...
    TEAM_STOPS_REPORT("Team Stops Report",106,EntityType.ENTITY_GROUP_LIST,
            new CriteriaType[]{CriteriaType.TIMEFRAME_ALT_DAYS}, 
            new GroupType[]{GroupType.TEAM}, ReportCategory.DriverPerformance, null,
            ReportType.TEAM_STOPS_REPORT),
    HOS_DAILY_DRIVER_LOG_REPORT("HOS Daily Driver Log Report",7,EntityType.ENTITY_GROUP_LIST_OR_DRIVER,
     ...
     DRIVER_PERFORMANCE_KEY_METRICS_TF("Driver Performance Key Metrics Time Frame", 44, EntityType.ENTITY_GROUP_LIST,
            new CriteriaType[]{CriteriaType.TIMEFRAME_ALT, CriteriaType.TIMEFRAME, CriteriaType.TIMEFRAME_ALT_PLUS_CUSTOM_RANGE}, 
            new GroupType[]{GroupType.DIVISION,GroupType.FLEET,GroupType.TEAM}, ReportCategory.DriverPerformance,
            EnumSet.of(ReportAccountType.PERFORMANCE),
            ReportType.DRIVER_PERFORMANCE_KEY_METRICS_TF),

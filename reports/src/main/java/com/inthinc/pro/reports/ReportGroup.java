...
public enum ReportGroup {
    ...
    DRIVERS_REPORT("Driver Report", 2, EntityType.ENTITY_GROUP, new CriteriaType[] { CriteriaType.DURATION, CriteriaType.INACTIVE_DRIVERS, CriteriaType.ZERO_MILES_DRIVERS }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET, GroupType.TEAM },
    ...
    // Performance
    PAYROLL_SUMMARY("Payroll Report Summary", 14, EntityType.ENTITY_GROUP_LIST, new CriteriaType[] {  CriteriaType.INACTIVE_DRIVERS_DECIMAL_TIME, CriteriaType.TIMEFRAME, CriteriaType.FILEFORMAT }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET, GroupType.TEAM },
            ReportCategory.Performance, EnumSet.of(ReportAccountType.WAYSMART, ReportAccountType.HOS), ReportType.PAYROLL_SUMMARY),
    PAYROLL_COMPENSATED_HOURS("Payroll Compensated Hours", 39, EntityType.ENTITY_GROUP_LIST, new CriteriaType[] {  CriteriaType.INACTIVE_DRIVERS_DECIMAL_TIME, CriteriaType.TIMEFRAME, }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET,
    ...
    PAYROLL_DETAIL("Payroll Report Driver Detail", 15, EntityType.ENTITY_GROUP_LIST, new CriteriaType[] {  CriteriaType.INACTIVE_DRIVERS_DECIMAL_TIME, CriteriaType.TIMEFRAME }, new GroupType[] { GroupType.DIVISION, GroupType.FLEET,
    ...
    PAYROLL_SIGNOFF("Payroll Report Driver Signoff", 16, EntityType.ENTITY_GROUP_LIST_OR_DRIVER, new CriteriaType[] {  CriteriaType.INACTIVE_DRIVERS_DECIMAL_TIME, CriteriaType.TIMEFRAME}, new GroupType[] { GroupType.DIVISION, GroupType.FLEET,
    ...
    DRIVER_PERFORMANCE_INDIVIDUAL("Driver Performance (Individual)", 35, EntityType.ENTITY_INDIVIDUAL_DRIVER, new CriteriaType[] { CriteriaType.TIMEFRAME, CriteriaType.INACTIVE_DRIVERS, CriteriaType.ZERO_MILES_DRIVERS }, new GroupType[] { GroupType.DIVISION,

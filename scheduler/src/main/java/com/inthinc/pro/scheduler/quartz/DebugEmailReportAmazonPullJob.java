...
/**
 * Debug version of the email pull job. Just change rsId to whatever report id you're debugging.
 */
public class DebugEmailReportAmazonPullJob extends QuartzJobBean implements StatefulJob {
    private static final Logger logger = Logger.getLogger(DebugEmailReportAmazonPullJob.class);
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try {
            ...
            while (true) {
                ...
                logger.info("PULL - " + rsId);
                ReportSchedule reportSchedule = getReportScheduleDirect(rsId);
    ...
    private ReportSchedule getReportScheduleDirect(int id) {
        return reportScheduleDAO.findByID(id);
    }

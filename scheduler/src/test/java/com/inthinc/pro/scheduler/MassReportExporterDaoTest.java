...
public class MassReportExporterDaoTest {
    ...
    private final Integer ACCOUNT_ID = 2012;
    private final Integer USER_ID = 8940;
    private final Integer GROUP_ID = 6197;
    private final Integer DRIVER_ID = 12325;
    ...
    private final Logger logger = Logger.getLogger(MassReportExporterDaoTest.class);
    private User user;
